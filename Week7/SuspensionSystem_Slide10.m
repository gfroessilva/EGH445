%% Feedforward Control to eliminate disturbance
...
u_ff = -pinv(sysD.B) * Bd_d * d; % (m x 1) % feedforward control to eliminate disturbance
...
f(3) = figure(3); f(3).Theme = 'light'; hold off
