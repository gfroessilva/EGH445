%% Non-zero state Regulation (and parameter uncertainty) through integral action with disturbance rejection
clear
LineWidth = 5;
FontSize = 30;
...
% Create a reference vector that starts at t=7 and ends at t_end
r = zeros(size(t));
r(t >= 7) = .5; 
...
f(7) = figure(7); f(7).Theme = 'light'; f(7).Color = 'white'; hold off
hold off
